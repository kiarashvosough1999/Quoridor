...
if __name__ == "__main__":
    ...
    while True:
        # white play
        action = white_player.get_best_action(opponent=black_player,maximizingPlayer=True)
        ...
        # black play
        action = black_player.get_best_action(opponent=white_player, maximizingPlayer=False)
